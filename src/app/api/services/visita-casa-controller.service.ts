...
export class VisitaCasaControllerService extends BaseService {
  constructor(
  ...
  /**
   * Path part for operation visitaCasaControllerGetCasa
   */
  static readonly VisitaCasaControllerGetCasaPath = '/visitas/{id}/casa';
  ...
  getCasa$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, VisitaCasaControllerService.VisitaCasaControllerGetCasaPath, 'get');
    if (params) {
